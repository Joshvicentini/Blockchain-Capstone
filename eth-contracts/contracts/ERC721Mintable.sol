...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Owner is required");
        _;
    }
...
contract Pausable is Ownable {
    ...
    modifier whenNotPaused() {
        require(_paused == false, "Contract should be upaused");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "Given address is the owner of the tokenId");
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    // create external getter function for name
    function name() external view returns (string memory) {
        return _name;
    }

    // create external getter function for symbol
    function symbol() external view returns (string memory) {
        return _symbol;
    }

    // create external getter function for baseTokenURI
...
contract ERC721Mintable is ERC721Metadata('Capstone','CS','https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/') {
